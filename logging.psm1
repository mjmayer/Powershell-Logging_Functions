...
Function Log-Email{
  ...
  Param ([Parameter(Mandatory=$true)][string]$LogPath, [Parameter(Mandatory=$true)][string]$EmailFrom, [Parameter(Mandatory=$true)][array]$EmailTo, [Parameter(Mandatory=$true)][string]$EmailSubject)
  
  Process{
    Try{
      #Create SMTP object and send email
      $sSmtpServer = "smtp.ucdavis.edu"
      $oSmtp = new-object Net.Mail.SmtpClient($sSmtpServer)
      $msg = new-object Net.Mail.MailMessage
      $msg.From = $EmailFrom
      $msg.Body = (Get-Content $LogPath | out-string)
